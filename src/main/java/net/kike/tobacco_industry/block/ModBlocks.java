...
import net.kike.tobacco_industry.block.custom.GemPolishingStationBlock;
import net.kike.tobacco_industry.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SOUND_BLOCK = registerBlock("sound_block",
            () -> new SoundBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(ModSounds.SOUND_BLOCKS_SOUNDS)));

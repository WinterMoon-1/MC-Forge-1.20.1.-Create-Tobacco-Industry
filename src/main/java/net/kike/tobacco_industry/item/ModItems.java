...
import net.kike.tobacco_industry.item.custom.FuelItem;
import net.kike.tobacco_industry.item.custom.MetalDetectorItem;
import net.kike.tobacco_industry.item.custom.ModArmorItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> SAPPHIRE_PICKAXE = ITEMS.register("sapphire_pickaxe",
            () -> new PickaxeItem(ModToolTiers.SAPPHIRE, 2, 1, new Item.Properties()));
    public static final RegistryObject<Item> SAPPHIRE_AXE = ITEMS.register("sapphire_axe",
            () -> new AxeItem(ModToolTiers.SAPPHIRE, 7, 1, new Item.Properties()));
    public static final RegistryObject<Item> SAPPHIRE_SHOVEL = ITEMS.register("sapphire_shovel",
            () -> new ShovelItem(ModToolTiers.SAPPHIRE, 2, 1, new Item.Properties()));

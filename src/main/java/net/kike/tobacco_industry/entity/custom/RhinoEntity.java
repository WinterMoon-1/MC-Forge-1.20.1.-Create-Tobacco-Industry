package net.kike.tobacco_industry.entity.custom;

import net.kike.tobacco_industry.entity.ModEntities;
import net.kike.tobacco_industry.entity.ai.RhinoAttackGoal;
...
public class RhinoEntity extends Animal {
    ...
    private void setupAnimationStates() {
        ...
        if(this.isAttacking() && attackAnimationTimeout <= 0) {
            attackAnimationTimeout = 80; // Lenght in ticks of your animation
